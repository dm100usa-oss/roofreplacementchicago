...
export const companies: Company[] = [
  ...
  },
  {
    ...
    tag: 'Highly Rated',
    tagEs: 'Muy valorado',
    desc: 'Est. 1997, Licensed. In our opinion, a dedicated residential roofing team with strong attention to detail and a focus on clean, efficient installations.',
    descEs: 'Est. 1997, Con licencia. En nuestra opinión, un equipo residencial dedicado con gran atención al detalle e instalaciones limpias y eficientes.',
    warranty: 'Workmanship warranty: 5 years',
    warrantyEs: 'Garantía de mano de obra: 5 años',
    expertRating: 4.5,
    googleRating: 4.8,
  ...
  },
  {
    ...
    tag: 'Highly Rated',
    tagEs: 'Muy valorado',
    desc: 'Est. 2019, Licensed, BBB A+. In our opinion, the best value choice in Chicago — family-owned with transparent pricing and one of the longest warranties in the city.',
    descEs: 'Est. 2019, Con licencia, BBB A+. En nuestra opinión, la mejor relación calidad-precio en Chicago: empresa familiar con precios transparentes y una de las mejores garantías.',
    warranty: 'Workmanship warranty: 10 years',
    warrantyEs: 'Garantía de mano de obra: 10 años',
    expertRating: 4.6,
    googleRating: 4.8,
