...
export const articles: Article[] = [
  {
    ...
    sections: [
      ...
      { heading: 'Get at least two estimates', text: 'Roofing prices vary significantly in Chicago. Getting two or three free estimates gives you a realistic sense of [fair pricing](/articles/average-cost) and lets you compare warranty terms. Be cautious of estimates that are dramatically lower than others — this often signals cut corners or substandard materials.' },
      ...
      { heading: 'Watch for red flags', text: 'Be wary of door-to-door solicitors after storms, companies that ask for full payment upfront, and anyone who refuses to provide a written estimate. Read our [repair vs replace guide](/articles/repair-vs-replace) to understand your full options before signing anything.' },
      { heading: 'Why our list saves you time', text: 'We pre-verify every company on our list for licensing, insurance, Google rating, and warranty terms — see [how we rank contractors](/articles/how-we-rank-companies) for the full methodology.' },
    ],
    ...
    sectionsEs: [
      ...
      { heading: 'Por qué nuestra lista le ahorra tiempo', text: 'Verificamos previamente cada empresa de nuestra lista en cuanto a licencia, seguro, calificación en Google y términos de garantía. Consulte [cómo clasificamos a los contratistas](/es/articles/how-we-rank-companies) para ver la metodología completa.' },
    ],
  },
  {
    slug: 'average-cost',
    ...
    sections: [
      ...
      { heading: 'Insurance may cover part or all of the cost', text: 'If your roof was damaged by hail, wind, or storm, your homeowner insurance policy may cover replacement. See our [storm damage guide](/articles/after-storm-damage) for step-by-step instructions on documenting damage and filing a claim.' },
      { heading: 'How to get an accurate estimate', text: 'All companies on our list offer free on-site estimates. The estimate should be written, itemized, and include labor, materials, disposal, permit costs, and warranty terms. See our guide on [how to choose a contractor](/articles/how-to-choose) for what else to look for.' },
    ],
    ...
    sectionsEs: [
      ...
      { heading: 'El seguro puede cubrir parte o todo el costo', text: 'Si su techo fue dañado por granizo, viento o tormenta, su póliza de seguro de propietario puede cubrir el reemplazo. Consulte nuestra [guía de daños por tormenta](/es/articles/after-storm-damage) para instrucciones paso a paso.' },
  ...
  },
  {
    ...
    sections: [
      ...
      { heading: 'When to call immediately', text: 'Call for emergency service if you see active water entry during rain, large sections of missing shingles after a storm, or visible structural damage. Not sure whether you need repair or full replacement? Read our [repair vs replace guide](/articles/repair-vs-replace).' },
    ],
    ...
    sectionsEs: [
      ...
      { heading: 'Cuándo llamar de inmediato', text: 'Llame para servicio de emergencia si ve entrada activa de agua durante la lluvia, grandes secciones de tejas faltantes después de una tormenta o daño estructural visible. ¿No sabe si necesita reparación o reemplazo completo? Lea nuestra [guía de reparación vs reemplazo](/es/articles/repair-vs-replace).' },
    ],
  },
  {
    ...
    sections: [
      ...
      { heading: 'Beware of storm chasers', text: 'After major Chicago storms, out-of-town contractors flood the area offering quick, cheap repairs. Many are unlicensed, uninsured, and do poor work. Use only local, verified contractors. Not sure whether to repair or replace? Read our [repair vs replace guide](/articles/repair-vs-replace). For ways to reduce your out-of-pocket costs, see [how to save money](/articles/save-money-chicago).' },
    ],
    ...
    sectionsEs: [
      ...
      { heading: 'Cuidado con los cazadores de tormentas', text: 'Después de las grandes tormentas de Chicago, contratistas de fuera de la ciudad inundan el área ofreciendo reparaciones rápidas y baratas. Muchos no tienen licencia ni seguro y hacen un trabajo deficiente. Use solo contratistas locales verificados. ¿No sabe si reparar o reemplazar? Lea nuestra [guía de reparación vs reemplazo](/es/articles/repair-vs-replace).' },
    ],
  },
  {
    ...
    sections: [
      ...
      { heading: 'How often we update', text: 'We review rankings regularly. If a company\'s license lapses, its Google rating drops significantly, or we receive credible negative information, we update or remove the listing immediately. Ready to call? See our guide on [how to choose a contractor](/articles/how-to-choose) and check [average replacement costs](/articles/average-cost) before you commit.' },
    ],
    ...
    sectionsEs: [
      ...
      { heading: 'Con qué frecuencia actualizamos', text: 'Revisamos las clasificaciones regularmente. Si la licencia de una empresa vence, su calificación de Google cae significativamente o recibimos información negativa creíble, actualizamos o eliminamos la ficha de inmediato. ¿Listo para llamar? Consulte nuestra guía sobre [cómo elegir un contratista](/es/articles/how-to-choose) y los [costos promedio de reemplazo](/es/articles/average-cost).' },
    ],
  },
  {
