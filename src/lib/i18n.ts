...
export const dict = {
  en: {
    ...
    faq2a: 'Minor repairs start around $200–$350. Storm damage or full section replacement typically runs $400–$1,500+. Prices vary by project scope and materials — all companies on our list offer free on-site estimates before any work begins.',
  ...
  es: {
    ...
    faq2a: 'Las reparaciones menores comienzan en $200–$350. Los daños por tormenta o el reemplazo de una sección completa suelen costar $400–$1,500+. Los precios varían según el alcance del proyecto y los materiales — todas las empresas ofrecen presupuestos gratuitos en el lugar antes de comenzar cualquier trabajo.',
